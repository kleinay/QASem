...
https://github.com/allenai/allennlp-models/blob/master/allennlp_models/common/ontonotes.py
 - Avoid installing AllenNLP when all you need as an utility class
"""
...
if __name__ == "__main__":
    # a quick testing script
    onto = Ontonotes()
    path = r"C:\dev\ontonotes\conll-formatted-ontonotes-5.0\data\train\data\english\annotations\nw\wsj\03\wsj_0302.gold_conll"
    docs = list(onto.dataset_document_iterator(path))
    print(docs[0][0])
